...
### Compiling BSP64 Enhanced

Clone this repository to a subdirectory of the "msys64" folder, which in this case is "C:\msys64\BSP64Enhanced".

In the "mingw32.exe" command window, move to the BSP64 Enhanced directory, which in this case is done with the "cd 'C:\msys64\BSP64Enhanced'" command.

Compile BSP64 Enhanced with the command "make".

In the "bin" folder of the "BSP64Enhanced" directory you will now have the nodebuilder executables.
